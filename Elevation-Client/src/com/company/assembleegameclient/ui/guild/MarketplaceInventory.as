...
import com.company.assembleegameclient.game.AGameSprite;
    ...
    public class MarketplaceInventory extends Sprite {
        ...
        public function MarketplaceInventory(_arg1:Vector.<int>, _arg2:Vector.<Object>, _arg3:AGameSprite, _arg4:int) {
            super();
        ...
        private function onClickSlot(event:MouseEvent):void {
            ...
            if(this.mode_ == 1) {
                var _local2:XML = ObjectLibrary.xmlLibrary_[_local1.item_];
