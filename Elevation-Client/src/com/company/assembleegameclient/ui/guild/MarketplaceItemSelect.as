...
import com.company.assembleegameclient.account.ui.DataChooser;
...
public class MarketplaceItemSelect extends Sprite {
        ...
        public function MarketplaceItemSelect(_arg1:AGameSprite) {
            super();
            this.gs_ = _arg1;
        ...
        private var search_:TextInputField;
        ...
        public function itemSearch(_arg1:String):void {
            ...
            if(_arg1 != "") {
                ...
                for(var p:int = 0; p < _local1.length; p++) {
                    if(ObjectLibrary.getIdFromType(_local1[p]) == null) {
                        continue;
                    }
                    var _local3:XML = ObjectLibrary.xmlLibrary_[_local1[p]];
        ...
        private function onClickItem(event:MouseEvent):void {
            ...
            if(this.inventory_.equipment_.length < 8) {
                var _local3:XML = ObjectLibrary.xmlLibrary_[_local1.item_];
                if(_local3 == null) {
                    return;
                }
