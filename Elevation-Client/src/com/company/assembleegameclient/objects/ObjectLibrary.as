...
//        "Banker": Banker
    ...
    public static function getRedrawnTextureFromType(_arg_1:int, _arg_2:int, _arg_3:Boolean, _arg_4:Boolean = true, _arg_5:Number = 5):BitmapData {
        ...
        if (_local_9 != null && _local_9.hasOwnProperty("Legendary")) {
    ...
    public static function getRedrawnTextureFromTypeCustom(_arg_1:int, _arg_2:int, _arg_3:Boolean, _arg_4:Object, _arg_5:Boolean = true, _arg6:Number = 5, _arg7:uint = 0, _arg8:uint = 0):BitmapData {
        var _local_6:BitmapData = getBitmapData(_arg_1);
        if (Parameters.itemTypes16.indexOf(_arg_1) != -1) {
            _arg_2 = (_arg_2 * 0.5);
        }
        ...
        var _local_8:BitmapData = ((_local_7) ? _local_7.mask_ : null);
        if (_local_8 == null) {
            return (TextureRedrawer.redraw(_local_8, _arg_2, _arg_3, _arg7, _arg8));
        }
        var _local_9:XML = xmlLibrary_[_arg_1];
        var _local_10:int = ((_local_9.hasOwnProperty("Tex1")) ? int(_local_9.Tex1) : 0);
        var _local_11:int = ((_local_9.hasOwnProperty("Tex2")) ? int(_local_9.Tex2) : 0);
        _local_6 = TextureRedrawer.resize(_local_6, _local_8, _arg_2, _arg_3, _local_10, _local_11, 1);
        _local_6 = GlowRedrawer.outlineGlow(_local_6, 0);
        return (_local_6);
    }
        ...
        if (_arg_1.toString() == "Stat") {
            ...
            switch (int(_arg_1.@stat)) {
                ...
                case StatData.MIGHT_STAT:
                    return ((_arg_2.might_ >= _local_3));
                case StatData.LUCK_STAT:
                    return ((_arg_2.luck_ >= _local_3));
            }
        }
        return (false);
    }
