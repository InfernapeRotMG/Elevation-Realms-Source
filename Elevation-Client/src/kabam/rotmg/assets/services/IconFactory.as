...
public class IconFactory {
    ...
    public static function makeSilver():BitmapData {
        var _local_1:BitmapData = TextureRedrawer.resize(AssetLibrary.getImageFromSet("lofiObj3", 1381), null, 40, true, 0, 0);
        return (cropAndGlowIcon(_local_1));
    }
    public static function makeBronze():BitmapData {
        var _local_1:BitmapData = TextureRedrawer.resize(AssetLibrary.getImageFromSet("lofiObj3", 1382), null, 40, true, 0, 0);
        return (cropAndGlowIcon(_local_1));
    }
