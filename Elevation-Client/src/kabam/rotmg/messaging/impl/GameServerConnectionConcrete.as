...
import kabam.rotmg.messaging.impl.incoming.MarketTradeResult;
import kabam.rotmg.messaging.impl.outgoing.MarketTrade;
import kabam.rotmg.messaging.impl.outgoing.MarketCreate;
...
public class GameServerConnectionConcrete extends GameServerConnection {
    ...
    public function mapMessages():void {
        ...
        _local_1.map(MARKETCREATE).toMessage(MarketCreate)
        _local_1.map(MARKETTRADE).toMessage(MarketTrade)
        ...
        _local_1.map(MARKETTRADERESULT).toMessage(MarketTradeResult).toMethod(this.marketTradeResult);
    ...
    override public function marketTrade(_arg1:int):void {
        var _local3:MarketTrade = (this.messages.require(MARKETTRADE) as MarketTrade);
        _local3.tradeId_ = _arg1;
        this.serverConnection.sendMessage(_local3);
    }

    override public function marketCreate(_arg1:Vector.<int>, _arg2:Vector.<int>, _arg3:Vector.<Object>):void {
        var _local3:MarketCreate = (this.messages.require(MARKETCREATE) as MarketCreate);
    ...
    private function marketTradeResult(_arg1:MarketTradeResult):void {
        ...
        //this.gs_.textBox_.addText(_arg1.success_ ? "" : Parameters.SendError, _arg1.errorText_);
            this.addTextLine.dispatch(ChatMessage.make(_arg1.success_ ? "" : Parameters.ERROR_CHAT_NAME, _arg1.errorText_));
        this.gs_.dispatchEvent(new GuildResultEvent(_arg1.success_, _arg1.errorText_, {}, GuildResultEvent.market_));
    }
        ...
        for each (_local_7 in _arg_2) {
            ...
            switch (_local_7.statType_) {
                ...
                case StatData.MIGHT_STAT:
                    _local_4.might_ = _local_8;
                    break;
                case StatData.LUCK_STAT:
                    _local_4.luck_ = _local_8;
                    break;
                case StatData.MIGHT_BOOST_STAT:
                    _local_4.mightBoost_ = _local_8;
                    break;
                case StatData.LUCK_BOOST_STAT:
                    _local_4.luckBoost_ = _local_8;
                    break;
    ...
    private function onGuildResult(_arg_1:GuildResult):void {
        ...
        if (_arg_1.lineBuilderJSON == "") {
            gs_.dispatchEvent(new GuildResultEvent(_arg_1.success_, "", {}, GuildResultEvent.EVENT));
        }
        else {
            ...
            gs_.dispatchEvent(new GuildResultEvent(_arg_1.success_, _local_2.key, _local_2.tokens, GuildResultEvent.EVENT));
        }
    }
