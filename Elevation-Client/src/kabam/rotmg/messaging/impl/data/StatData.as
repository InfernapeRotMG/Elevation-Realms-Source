...
public class StatData {
    ...
    public static const MIGHT_STAT:int = 98;
    public static const LUCK_STAT:int = 99;
    public static const MIGHT_BOOST_STAT:int = 100;
    public static const LUCK_BOOST_STAT:int = 101;
