    ...
    internal class PlayerShootPacketHandler : PacketHandlerBase<PlayerShootPacket>
    {
        ...
        protected override void HandlePacket(Client client, PlayerShootPacket packet)
        {
            client.Manager.Logic.AddPendingAction(t =>
            {
                ...
                if (client.Player.SlotTypes[stype] != item.SlotType && !client.Account.Admin)
                {
                ...
                Projectile prj = client.Player.PlayerShootProjectile(packet.BulletId, prjDesc, item.ObjectType, packet.Position, packet.Angle);
