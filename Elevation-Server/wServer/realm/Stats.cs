...
namespace wServer.realm
{
    ...
    public struct StatsType
    {
        ...
        */
        ...
        public static readonly StatsType Might = 98;
        public static readonly StatsType Luck = 99;
        public static readonly StatsType MightBonus = 100;
        public static readonly StatsType LuckBonus = 101;
		public static readonly StatsType StarType = 102;
        ...
        public bool IsUTF()
        {
            if(this == Name || this == AccountId || this == StatsType.OwnerAccountId || this == Guild || this == PetSkin)
                    return true;
            return false;
        }
