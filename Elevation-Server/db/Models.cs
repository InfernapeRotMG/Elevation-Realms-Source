...
public class Stats
{
    ...
    [XmlElement("Stars")]
    public int StarsOverride { get; set; }
...
public class Offer
{
    ...
    {
        get { return Utils.FromCommaSepString16z(_OfferItems); }
        set { _OfferItems = Utils.GetCommaSepString(value); }
    }

    [XmlIgnore]
    public db.ItemData[] OfferData
    {
        get { return db.ItemDataList.CreateData(_OfferData); }
        set { _OfferData = db.ItemDataList.GetJson(value); }
    }

    [XmlIgnore]
    public ushort[] RequestItems
    {
        get { return Utils.FromCommaSepString16z(_RequestItems); }
        set { _RequestItems = Utils.GetCommaSepString(value); }
    }

    [XmlIgnore]
    public db.ItemData[] RequestData
    {
        get { return db.ItemDataList.CreateData(_RequestData); }
        set { _RequestData = db.ItemDataList.GetJson(value); }
    }
}