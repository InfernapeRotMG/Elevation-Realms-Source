...
public class ActivateEffect
{
    public ActivateEffect(XElement elem)
    {
        ...
        if (elem.Attribute("boxType") != null)
            BoxType = elem.Attribute("boxType").Value;
...
public class ObjectDesc
{
    public ObjectDesc(ushort type, XElement elem)
    {
        ...
        if ((n = elem.Element("Might")) != null)
            MaxMight = n.Attribute("max") != null ? Utils.FromString(n.Attribute("max").Value) : -1;
        ...
        DDSResistance = elem.Element("DDSResistance") != null;
    ...
    public int MaxMight { get; private set; }
    ...
    public bool DDSResistance { get; private set; }
