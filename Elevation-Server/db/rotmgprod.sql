...
CREATE TABLE IF NOT EXISTS `accounts` (
  ...
  `isAgeVerified` tinyint(1) NOT NULL DEFAULT '1',
...
-- Dumping data for table rotmgprod.accounts: 0 rows
...
-- Dumping data for table rotmgprod.arenalb: 0 rows
/*!40000 ALTER TABLE `arenalb` DISABLE KEYS */;
/*!40000 ALTER TABLE `arenalb` ENABLE KEYS */;
...
-- Dumping data for table rotmgprod.backpacks: 0 rows
...
-- Dumping data for table rotmgprod.boards: 0 rows
...
-- Dumping data for table rotmgprod.characters: 0 rows
...
-- Dumping data for table rotmgprod.classstats: 0 rows
...
-- Dumping data for table rotmgprod.dailyquests: ~0 rows (approximately)
/*!40000 ALTER TABLE `dailyquests` DISABLE KEYS */;
/*!40000 ALTER TABLE `dailyquests` ENABLE KEYS */;
...
-- Dumping data for table rotmgprod.death: 0 rows
...
-- Dumping data for table rotmgprod.giftcodes: ~0 rows (approximately)
...
-- Dumping data for table rotmgprod.globalnews: ~0 rows (approximately)
/*!40000 ALTER TABLE `globalnews` DISABLE KEYS */;
/*!40000 ALTER TABLE `globalnews` ENABLE KEYS */;
...
-- Dumping data for table rotmgprod.guilds: 0 rows
...
-- Dumping data for table rotmgprod.mysteryboxes: ~0 rows (approximately)
/*!40000 ALTER TABLE `mysteryboxes` DISABLE KEYS */;
/*!40000 ALTER TABLE `mysteryboxes` ENABLE KEYS */;
...
-- Dumping data for table rotmgprod.news: 0 rows
...
-- Dumping data for table rotmgprod.packages: ~0 rows (approximately)
...
-- Dumping data for table rotmgprod.pets: 0 rows
...
-- Dumping data for table rotmgprod.stats: 0 rows
...
-- Dumping data for table rotmgprod.thealchemist: ~0 rows (approximately)
/*!40000 ALTER TABLE `thealchemist` DISABLE KEYS */;
/*!40000 ALTER TABLE `thealchemist` ENABLE KEYS */;
...
-- Dumping data for table rotmgprod.unlockedclasses: ~0 rows (approximately)
/*!40000 ALTER TABLE `unlockedclasses` DISABLE KEYS */;
/*!40000 ALTER TABLE `unlockedclasses` ENABLE KEYS */;
...
-- Dumping data for table rotmgprod.vaults: 0 rows
